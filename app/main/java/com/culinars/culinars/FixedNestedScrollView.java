...
public class FixedNestedScrollView extends NestedScrollView {
    ...
    public FixedNestedScrollView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FixedNestedScrollView(Context context, @Nullable AttributeSet attrs, int defStyle) {
